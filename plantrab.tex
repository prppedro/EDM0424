...
\begin{document}
	...
	Conversa livre: se dispor a perguntar aos alunos questões não 
	triviais que os forçam a produzir filosofia e pensar de maneira
	organizada, e -- também -- responder perguntas dos mesmos sobre 
	questões de suas realidades buscando inspira-los a buscar 
	conhecimento na literatura da disciplina e relacionar problemas 
	com a necessidade de desenvolver filosofia autenticamente.
