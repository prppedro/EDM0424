...
%	\epigraph{\emph{
	...
	Não se sabe com precisão, o que as pessoas deste tempo esperam da 
	filosofia. Procurar compreendê-lo é em si, como já discutido, um 
	esforço filosófico propriamente dito. Além disso, quanto a questão 
	é posta dentro dos confins da educação, percebe-se que o estudante 
	formula as questões de acordo com o instrumental e vivência a que 
	tem acesso, de acordo com seu meio e situação social. 

	Ora, não se sabe o que este estudante espera da filosofia. Sabe-se, 
	todavia, que para que ele espere algo, é preciso que haja contato 
	com a filosofia. E também com o \textit{filosofar}. “Filosofar” 
	ou ”ser filósofo”, é verdade, são duas ideias que, para muitos de 
	nós, chegam a ter uma conotação diletante. É uma atividade exercida 
	por pessoas que “descuidam da práxis”
	\footnote{cf. \cite{bolzani}, p. 32}. 

	Quando, a bem da verdade, o homem, este eterno animal político, 
	sempre carregara em seu cerne uma inclinação à curiosidade, ao 
	questionamento. Exercê-las em sua plenitude é, afinal, filosofar. 
	Os chamados “exercícios espirituais” parecem uma saída interessante, 
	neste ponto. Estabelecer rodas de conversa e debater assuntos do 
	meio e da atualidade sempre deveria ser uma atividade imprescindível 
	não só ao pupilo ou ao preceptor, mas também a qualquer indivíduo 
	inclinado ao estudo da filosofia. 

	Pois é a filosofia, porquanto, viva. A “mãe de todas as ciências” 
	está em constante movimento. Não um movimento retilínio uniforme, 
	mas um movimento difuso, divergente. A cada nova página de jornal, 
	há novas discussões a se pôr à mesa. Logo, filosofar consiste no 
	primeiro momento. 

	Em um segundo momento, é conveniente relembrar a famosa frase de 
	George Santayana: “um povo que não relembra seu passado, está 
	fadado a repetí-lo”. É preciso criar pontes entre a filosofia viva 
	e a filosofia de outrora. Contextualizar as discussões, mapeá-las 
	às obras de grandes escritores, de notáveis cineastas, de grandes 
	artistas. O filosofar do estudante de classe média baixa pode ter 
	muito mais em comum com o jovem estudante medieval do que suporia 
	nossa vã filosofia. 

	O principal esforço desta proposta consiste em procurar criar estes 
	dois momentos, esquivando-se, o máximo possível, das pressões 
	burocráticas e administrativas. São tarefas que representam um 
	constante desafio e alta capacidade de adaptação do docente. 
	...
	Para Sexto, ”não há objeto passível de ensino”. Uma formidável ironia, 
	posto que o cético formula esta ideia enquanto propriamente professa 
	os preceitos da ”doutrina” pirrônica. Terá Sexto ignorado este 
	detalhe? O que talvez nos escape seja uma das mais importâncias 
	denúncias do cético: a de que nada do que se fala pode ser, de fato, 
	compreendido. O ensino é, portanto, uma extensiva operação de 
	tentativa e erro, em que a mensagem, com toda a certeza, nunca chegará 
	intacta ao estudante. É, contudo, nosso dever fazê-la chegar com a 
	maior integridade possível. 
